                ...
                <div class="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-72 mx-2">
                    ...
                    <div class="z-0 order-1 md:order-2 relative w-full md:w-2/5 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-r-lg">
                        <div class="absolute inset-0 w-full h-full object-fill object-center bg-cover bg-bottom">
                            <video controls class="w-full h-full" :id="`vr-${i}`">
                            <source :src="e.path" type="video/mp4">
                            </video>
                        </div>
                        <svg @click="videoToggle(i)" class="hidden md:block absolute inset-y-0 h-full w-24 fill-current text-white -ml-12" viewBox="0 0 100 100" preserveAspectRatio="none">
...
const videos = [
    {
        id: 0,
        path: 'videos/0.mp4',
        nombre: '¿Qué hacer en caso de una quemadura?',
        descripcion: `Las quemaduras habitualmente ocurren por contacto directo o indirecto con calor, corriente eléctrica, radiación o agentes químicos. Las quemaduras pueden provocar muerte celular, lo que puede requerir hospitalización y causar la muerte.`
    },
    {
        id: 1,
        path: 'videos/1.mp4',
        nombre: '¿Qué hacer en caso de desmayo?',
        descripcion: `Los desmayos se presentan cuando el cerebro deja temporalmente de recibir suficiente sangre, lo que hace que pierdas el conocimiento. Esta pérdida del conocimiento suele ser breve.`
    },
    {
        id: 2,
        path: 'videos/2.mp4',
        nombre: '¿Qué hacer cuando te estiran del brazo?',
        descripcion: `Esta es una de las técnicas más comunes de los atacantes por esto es importante tener este conocimiento.`
    },
    {
        id: 3,
        path: 'videos/3.mp4',
        nombre: '¿Qué hacer si sufres un ataque de ansiedad?',
        descripcion: `¿Qué es la ansiedad?
                    Es una afección mental en la cual usted está con frecuencia preocupado o ansioso acerca de muchas situaciones diferentes. Su ansiedad puede parecer fuera de control e interponerse en sus actividades cotidianas.`
    },
    {
        id: 4,
        path: 'videos/4.mp4',
        nombre: "¿Qué hacer ante un infarto al corazón?",
        descripcion: `
    ...
    },
    {
        id: 5,
        path: 'videos/5.mp4',
        nombre: '¿Qué debería hacer si alguien me persigue por la calle?',
        descripcion: `Una de las experiencias más aterradoras y espeluznantes es tener la sensación de que alguien te está siguiendo.`
    },
    {
        id: 6,
        nombre: '¿Qué hacer en caso de heridas?',
        descripcion: `
...
export default {
    ...
    methods:{
        videoToggle(index){
            const $video = document.getElementById("vr-"+index);
